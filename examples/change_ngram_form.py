...
import random
# k6_file =open("ngram_k/k6.txt", 'r')
# k7_file =open("ngram_k/k7.txt", 'r')
# k8_file =open("ngram_k/k8.txt", 'r')
# k9_file =open("ngram_k/k9.txt", 'r')
# k10_file =open("ngram_k/k10.txt", 'r')
# k11_file =open("ngram_k/k11.txt", 'r')
# k12_file =open("ngram_k/k12.txt", 'r')
